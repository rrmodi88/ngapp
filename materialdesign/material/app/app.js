var mainApp = angular.module('mainApp', ['ngMaterial','ui.router','demoApp']);
mainApp.config([
	'$urlRouterProvider', '$locationProvider', '$httpProvider', '$mdThemingProvider', '$mdIconProvider',
	function ($urlRouterProvider, $locationProvider, $httpProvider,$mdThemingProvider,$mdIconProvider) {
